...
/**
 * Twitter card image. Reuses the same design as the Open Graph
 * image — Twitter accepts 1200x630 and 1200x600, both render fine
    ...
    >
      <div
        style={{
          ...
          bottom: 0,
          background:
            'radial-gradient(circle at 0% 0%, rgba(99, 102, 241, 0.2) 0%, rgba(99, 102, 241, 0) 40%), radial-gradient(circle at 100% 100%, rgba(244, 63, 94, 0.14) 0%, rgba(244, 63, 94, 0) 50%)',
          display: 'flex',
        }}
      />
      <div
